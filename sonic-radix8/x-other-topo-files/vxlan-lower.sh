...
# node00
clab tools vxlan create --remote 198.18.1.101 --id 1000 --link node00-eth2 
clab tools vxlan create --remote 198.18.1.101 --id 1001 --link node00-eth3     
clab tools vxlan create --remote 198.18.1.101 --id 1002 --link node00-eth4 
clab tools vxlan create --remote 198.18.1.101 --id 1003 --link node00-eth5 
clab tools vxlan create --remote 198.18.1.101 --id 1004 --link node00-eth6
clab tools vxlan create --remote 198.18.1.101 --id 1005 --link node00-eth7
clab tools vxlan create --remote 198.18.1.101 --id 1006 --link node00-eth8  
