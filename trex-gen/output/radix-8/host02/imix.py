...
class STLIPv6(object):
    ...
    def get_streams(self, direction=0, **kwargs):
        ...
        dst_subnets = ['fc00:0:f800:0::/64', 'fc00:0:f800:2::/64', 'fc00:0:f800:6::/64', 'fc00:0:f800:8::/64', 'fc00:0:f800:10::/64', 'fc00:0:f800:12::/64', 'fc00:0:f800:14::/64', 'fc00:0:f800:16::/64']
        
        # Source subnet
        src_subnet = 'fc00:0:f800:4::/64'
