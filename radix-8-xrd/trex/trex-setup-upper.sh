...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801::1 dev eth1
...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801:4::1 dev eth2
...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801:8::1 dev eth3
...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801:c::1 dev eth4
...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801:10::1 dev eth5
...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801:14::1 dev eth6
...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801:18::1 dev eth7
...
docker exec -it clab-clos-host04 ip -6 route add fc00:0::/32 via fc00:0:f801:1c::1 dev eth8
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:1::1 dev eth1
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:5::1 dev eth2
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:9::1 dev eth3
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:d::1 dev eth4
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:11::1 dev eth5
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:15::1 dev eth6
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:19::1 dev eth7
...
docker exec -it clab-clos-host05 ip -6 route add fc00:0::/32 via fc00:0:f801:1d::1 dev eth8
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:2::1 dev eth1
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:6::1 dev eth2
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:a::1 dev eth3
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:e::1 dev eth4
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:12::1 dev eth5
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:16::1 dev eth6
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:1a::1 dev eth7
...
docker exec -it clab-clos-host06 ip -6 route add fc00:0::/32 via fc00:0:f801:1e::1 dev eth8
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:3::1 dev eth1
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:7::1 dev eth2
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:b::1 dev eth3
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:f::1 dev eth4
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:13::1 dev eth5
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:17::1 dev eth6
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:1b::1 dev eth7
...
docker exec -it clab-clos-host07 ip -6 route add fc00:0::/32 via fc00:0:f801:1f::1 dev eth8
